...
class Product(models.Model):
    ...
    product_picture = models.ImageField(upload_to='photos/',blank=False, null=False,  verbose_name='фотография')
    ...
    author = models.ForeignKey(CustomUser, verbose_name="автор", blank=True, null=True, on_delete=models.CASCADE)
